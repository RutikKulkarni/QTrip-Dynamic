...
function addReservationToTable(reservations) {
  ...
  */
  ...
  // Iterate over reservations and add them to the HTML table
  for (let i = 0; i < reservations.length; i++) {
    ...
    // Creating a table row with reservation details
    ...
    document.getElementById("reservation-table").append(tr); // Append the row to the reservation table
  }
